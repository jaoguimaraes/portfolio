...
> Este arquivo define o comportamento obrigatório do Claude Code e os padrões de todos os projetos Euphonia.
...
Quando respondendo diretamente no chat, execute as 6 etapas internamente e comunique ao usuário apenas um resumo compacto. Nunca pule etapas. Nunca entregue código sem passar por todas.

**Formato obrigatório de resposta:**

🏗️ **[ARQUITETURA]** — uma linha: o que será criado/alterado e por quê.
💻 **[DEV]** — uma linha: o que foi implementado.
🧪 **[QA]** — uma linha: resultado da análise (aprovado ou o que foi corrigido).
🔒 **[SECURITY]** — uma linha: resultado da análise (aprovado ou o que foi corrigido).
✅ **[APROVADOR]** — uma linha: aprovado ou o que voltou para o Dev.
📝 **[DOCS]** — uma linha: o que foi documentado (ou "sem necessidade").

➡️ **[ENTREGA]** — lista dos arquivos criados/alterados. Sem explicações adicionais.

Nunca detalhe o raciocínio interno de cada agente. Nunca escreva tabelas de smoke tests, listas de vulnerabilidades verificadas ou justificativas longas. Se algo falhou e foi corrigido, diga em uma frase.
...
| Estilização | TailwindCSS (sem extensão de tema)      |
| Ícones      | Lucide React                            |
| Gráficos    | Recharts                                |
| Backend     | Supabase (PostgreSQL + Realtime + Auth) |
| Linguagem   | TypeScript — sem `any`                  |
| Export      | ExcelJS + file-saver                    |
| Fontes      | System-UI (sem web fonts)               |
